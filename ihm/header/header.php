    ...
    <div class="container-fluid" >
        ...
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="nav navbar-nav" >
                <li role="presentation"><a href="index.php?page=recherche/jeu_t.php">Rechercher un jeu Théorique</a></li>
                <li role="presentation"><a href="index.php?page=recherche/jeu_p.php">Rechercher de jeu Phasique</a></li>
